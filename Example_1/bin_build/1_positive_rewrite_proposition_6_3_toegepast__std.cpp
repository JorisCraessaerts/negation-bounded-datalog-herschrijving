...
namespace  souffle {
using namespace souffle;
class Sf___positive_rewrite_proposition_6_3_toegepast__std: public SouffleProgram {
public:
 Sf___positive_rewrite_proposition_6_3_toegepast__std(std::string pf = "profile.log");
 ~Sf___positive_rewrite_proposition_6_3_toegepast__std();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___positive_rewrite_proposition_6_3_toegepast__std::Sf___positive_rewrite_proposition_6_3_toegepast__std(std::string pf):
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___positive_rewrite_proposition_6_3_toegepast__std::~Sf___positive_rewrite_proposition_6_3_toegepast__std(){
}

void Sf___positive_rewrite_proposition_6_3_toegepast__std::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::run(){
runFunction("", "", false, false);
}

void Sf___positive_rewrite_proposition_6_3_toegepast__std::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___positive_rewrite_proposition_6_3_toegepast__std::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_conflict_free"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::dumpInputs(){
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___positive_rewrite_proposition_6_3_toegepast__std::getSymbolTable(){
return symTable;
}

RecordTable& Sf___positive_rewrite_proposition_6_3_toegepast__std::getRecordTable(){
return recordTable;
}

void Sf___positive_rewrite_proposition_6_3_toegepast__std::setNumThreads(std::size_t numThreadsValue){
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "T1") {
stratum_T1_5c3ab2c64a54be91.run(args, ret);
return;}
if (name == "T2") {
...
void Sf___positive_rewrite_proposition_6_3_toegepast__std::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___positive_rewrite_proposition_6_3_toegepast__std(){return new  souffle::Sf___positive_rewrite_proposition_6_3_toegepast__std;}
SymbolTable *getST___positive_rewrite_proposition_6_3_toegepast__std(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___positive_rewrite_proposition_6_3_toegepast__std*>(p)->getSymbolTable();}
} // namespace souffle
...
souffle::Sf___positive_rewrite_proposition_6_3_toegepast__std obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___positive_rewrite_proposition_6_3_toegepast__std: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___positive_rewrite_proposition_6_3_toegepast__std();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___positive_rewrite_proposition_6_3_toegepast__std::newInstance(){
return new  souffle::Sf___positive_rewrite_proposition_6_3_toegepast__std();
}

 factory_Sf___positive_rewrite_proposition_6_3_toegepast__std::factory_Sf___positive_rewrite_proposition_6_3_toegepast__std():
souffle::ProgramFactory("__positive_rewrite_proposition_6_3_toegepast__std"){
}
...
extern "C" {
souffle::factory_Sf___positive_rewrite_proposition_6_3_toegepast__std __factory_Sf___positive_rewrite_proposition_6_3_toegepast__std_instance;
}
#endif
} // namespace souffle
