...
{
	Logger logger(R"_(@t-nonrecursive-relation;T1;2_proposition_3.9_toegepast.dl [10:7-10:9];)_",iter, [&](){return rel_T1_d16b537d059aa637->size();});
signalHandler->setMsg(R"_(T1(z,x,x2,y2,x,y) :- 
   ...
   x != z,
   y != z.
in file 2_proposition_3.9_toegepast.dl [11:1-16:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T1;2_proposition_3.9_toegepast.dl [11:1-16:12];T1(z,x,x2,y2,x,y) :- \n   edge(x,y),\n   edge(y,z),\n   adom(x2),\n   adom(y2),\n   x != z,\n   y != z.;)_",iter, [&](){return rel_T1_d16b537d059aa637->size();});
...
if( (ramBitCast<RamDomain>(env0[0]) != ramBitCast<RamDomain>(env1[1])) && (ramBitCast<RamDomain>(env0[1]) != ramBitCast<RamDomain>(env1[1]))) {
...
signalHandler->setMsg(R"_(T1(z,x,x2,y2,x,y) :- 
   ...
   x != z,
   z != x.
in file 2_proposition_3.9_toegepast.dl [18:1-23:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T1;2_proposition_3.9_toegepast.dl [18:1-23:12];T1(z,x,x2,y2,x,y) :- \n   edge(x,y),\n   edge(y,z),\n   adom(x2),\n   adom(y2),\n   x != z,\n   z != x.;)_",iter, [&](){return rel_T1_d16b537d059aa637->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T1_d16b537d059aa637_op_ctxt,rel_T1_d16b537d059aa637->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
auto range = rel_edge_04d25f5060e9043b->lowerUpperRange_10(Tuple<RamDomain,2>{{ramBitCast(env0[1]), ramBitCast<RamDomain>(MIN_RAM_SIGNED)}},Tuple<RamDomain,2>{{ramBitCast(env0[1]), ramBitCast<RamDomain>(MAX_RAM_SIGNED)}},READ_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamDomain>(env0[0]) != ramBitCast<RamDomain>(env1[1])) && (ramBitCast<RamDomain>(env1[1]) != ramBitCast<RamDomain>(env0[0]))) {
for(const auto& env2 : *rel_adom_c76027b3f67642db) {
for(const auto& env3 : *rel_adom_c76027b3f67642db) {
Tuple<RamDomain,6> tuple{{ramBitCast(env1[1]),ramBitCast(env0[0]),ramBitCast(env2[0]),ramBitCast(env3[0]),ramBitCast(env0[0]),ramBitCast(env0[1])}};
rel_T1_d16b537d059aa637->insert(tuple,READ_OP_CONTEXT(rel_T1_d16b537d059aa637_op_ctxt));
...
signalHandler->setMsg(R"_(T1(z,x,x2,y2,x,y) :- 
   ...
   y != x,
   y != z.
in file 2_proposition_3.9_toegepast.dl [25:1-30:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T1;2_proposition_3.9_toegepast.dl [25:1-30:12];T1(z,x,x2,y2,x,y) :- \n   edge(x,y),\n   edge(y,z),\n   adom(x2),\n   adom(y2),\n   y != x,\n   y != z.;)_",iter, [&](){return rel_T1_d16b537d059aa637->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T1_d16b537d059aa637_op_ctxt,rel_T1_d16b537d059aa637->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
signalHandler->setMsg(R"_(T1(z,x,x2,y2,x,y) :- 
   ...
   y != x,
   z != x.
in file 2_proposition_3.9_toegepast.dl [32:1-37:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T1;2_proposition_3.9_toegepast.dl [32:1-37:12];T1(z,x,x2,y2,x,y) :- \n   edge(x,y),\n   edge(y,z),\n   adom(x2),\n   adom(y2),\n   y != x,\n   z != x.;)_",iter, [&](){return rel_T1_d16b537d059aa637->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T1_d16b537d059aa637_op_ctxt,rel_T1_d16b537d059aa637->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
{
	Logger logger(R"_(@t-nonrecursive-relation;T2;2_proposition_3.9_toegepast.dl [40:7-40:9];)_",iter, [&](){return rel_T2_a2eb4c083fff8b50->size();});
signalHandler->setMsg(R"_(T2(x1,y1,y,z,x,y) :- 
   ...
   x != y,
   y != z.
in file 2_proposition_3.9_toegepast.dl [41:1-46:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T2;2_proposition_3.9_toegepast.dl [41:1-46:12];T2(x1,y1,y,z,x,y) :- \n   edge(x,y),\n   edge(z,x),\n   adom(x1),\n   adom(y1),\n   x != y,\n   y != z.;)_",iter, [&](){return rel_T2_a2eb4c083fff8b50->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
...
for(const auto& env1 : range) {
if( (ramBitCast<RamDomain>(env0[1]) != ramBitCast<RamDomain>(env1[0]))) {
for(const auto& env2 : *rel_adom_c76027b3f67642db) {
for(const auto& env3 : *rel_adom_c76027b3f67642db) {
...
signalHandler->setMsg(R"_(T2(x1,y1,y,z,x,y) :- 
   ...
   x != y,
   z != x.
in file 2_proposition_3.9_toegepast.dl [48:1-53:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T2;2_proposition_3.9_toegepast.dl [48:1-53:12];T2(x1,y1,y,z,x,y) :- \n   edge(x,y),\n   edge(z,x),\n   adom(x1),\n   adom(y1),\n   x != y,\n   z != x.;)_",iter, [&](){return rel_T2_a2eb4c083fff8b50->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt,rel_T2_a2eb4c083fff8b50->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
auto range = rel_edge_04d25f5060e9043b->lowerUpperRange_01(Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MIN_RAM_SIGNED), ramBitCast(env0[0])}},Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MAX_RAM_SIGNED), ramBitCast(env0[0])}},READ_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamDomain>(env1[0]) != ramBitCast<RamDomain>(env0[0]))) {
for(const auto& env2 : *rel_adom_c76027b3f67642db) {
for(const auto& env3 : *rel_adom_c76027b3f67642db) {
Tuple<RamDomain,6> tuple{{ramBitCast(env2[0]),ramBitCast(env3[0]),ramBitCast(env0[1]),ramBitCast(env1[0]),ramBitCast(env0[0]),ramBitCast(env0[1])}};
rel_T2_a2eb4c083fff8b50->insert(tuple,READ_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt));
...
signalHandler->setMsg(R"_(T2(x1,y1,y,z,x,y) :- 
   ...
   adom(y1),
   y != z.
in file 2_proposition_3.9_toegepast.dl [55:1-60:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T2;2_proposition_3.9_toegepast.dl [55:1-60:12];T2(x1,y1,y,z,x,y) :- \n   edge(x,y),\n   edge(z,x),\n   adom(x1),\n   adom(y1),\n   y != z.;)_",iter, [&](){return rel_T2_a2eb4c083fff8b50->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt,rel_T2_a2eb4c083fff8b50->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
signalHandler->setMsg(R"_(T2(x1,y1,y,z,x,y) :- 
   ...
   y != z,
   z != x.
in file 2_proposition_3.9_toegepast.dl [62:1-67:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;T2;2_proposition_3.9_toegepast.dl [62:1-67:12];T2(x1,y1,y,z,x,y) :- \n   edge(x,y),\n   edge(z,x),\n   adom(x1),\n   adom(y1),\n   y != z,\n   z != x.;)_",iter, [&](){return rel_T2_a2eb4c083fff8b50->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt,rel_T2_a2eb4c083fff8b50->createContext());
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
...
auto range = rel_edge_04d25f5060e9043b->lowerUpperRange_01(Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MIN_RAM_SIGNED), ramBitCast(env0[0])}},Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MAX_RAM_SIGNED), ramBitCast(env0[0])}},READ_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamDomain>(env0[1]) != ramBitCast<RamDomain>(env1[0])) && (ramBitCast<RamDomain>(env1[0]) != ramBitCast<RamDomain>(env0[0]))) {
for(const auto& env2 : *rel_adom_c76027b3f67642db) {
for(const auto& env3 : *rel_adom_c76027b3f67642db) {
Tuple<RamDomain,6> tuple{{ramBitCast(env2[0]),ramBitCast(env3[0]),ramBitCast(env0[1]),ramBitCast(env1[0]),ramBitCast(env0[0]),ramBitCast(env0[1])}};
rel_T2_a2eb4c083fff8b50->insert(tuple,READ_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt));
...
{
	Logger logger(R"_(@t-nonrecursive-relation;adom;2_proposition_3.9_toegepast.dl [5:7-5:11];)_",iter, [&](){return rel_adom_c76027b3f67642db->size();});
signalHandler->setMsg(R"_(adom(x) :- 
   edge(x,_).
in file 2_proposition_3.9_toegepast.dl [6:1-6:23])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;adom;2_proposition_3.9_toegepast.dl [6:1-6:23];adom(x) :- \n   edge(x,_).;)_",iter, [&](){return rel_adom_c76027b3f67642db->size();});
...
signalHandler->setMsg(R"_(adom(x) :- 
   edge(_,x).
in file 2_proposition_3.9_toegepast.dl [7:1-7:23])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;adom;2_proposition_3.9_toegepast.dl [7:1-7:23];adom(x) :- \n   edge(_,x).;)_",iter, [&](){return rel_adom_c76027b3f67642db->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
...
{
	Logger logger(R"_(@t-relation-loadtime;edge;2_proposition_3.9_toegepast.dl [1:7-1:11];loadtime;)_",iter, [&](){return rel_edge_04d25f5060e9043b->size();});
if (performIO) {
...
ProfileEventSingleton::instance().makeQuantityEvent( R"(@n-nonrecursive-relation;edge;2_proposition_3.9_toegepast.dl [1:7-1:11];)",rel_edge_04d25f5060e9043b->size(),iter);}
...
{
	Logger logger(R"_(@t-nonrecursive-relation;output0;2_proposition_3.9_toegepast.dl [70:7-70:14];)_",iter, [&](){return rel_output0_8b84c88df5f1a24a->size();});
signalHandler->setMsg(R"_(output0(x1,y1,x2,y2,x,y) :- 
   ...
   adom(x2),
   adom(y2).
in file 2_proposition_3.9_toegepast.dl [71:1-76:24])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;output0;2_proposition_3.9_toegepast.dl [71:1-76:24];output0(x1,y1,x2,y2,x,y) :- \n   edge(x,y),\n   edge(y,z),\n   edge(z,x),\n   adom(x1),\n   adom(y1),\n   adom(x2),\n   adom(y2).;)_",iter, [&](){return rel_output0_8b84c88df5f1a24a->size();});
if(!(rel_adom_c76027b3f67642db->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_adom_c76027b3f67642db_op_ctxt,rel_adom_c76027b3f67642db->createContext());
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
...
signalHandler->setMsg(R"_(output0(x1,y1,x2,y2,x,y) :- 
   ...
   T2(x1,y1,x2,y2,x,y),
   x != y.
in file 2_proposition_3.9_toegepast.dl [79:1-82:12])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;output0;2_proposition_3.9_toegepast.dl [79:1-82:12];output0(x1,y1,x2,y2,x,y) :- \n   T1(x1,y1,x2,y2,x,y),\n   T2(x1,y1,x2,y2,x,y),\n   x != y.;)_",iter, [&](){return rel_output0_8b84c88df5f1a24a->size();});
...
if( (ramBitCast<RamDomain>(env0[4]) != ramBitCast<RamDomain>(env0[5])) && rel_T2_a2eb4c083fff8b50->contains(Tuple<RamDomain,6>{{ramBitCast(env0[0]),ramBitCast(env0[1]),ramBitCast(env0[2]),ramBitCast(env0[3]),ramBitCast(env0[4]),ramBitCast(env0[5])}},READ_OP_CONTEXT(rel_T2_a2eb4c083fff8b50_op_ctxt))) {
...
{
	Logger logger(R"_(@t-nonrecursive-relation;result_conflict_free;2_proposition_3.9_toegepast.dl [85:7-85:27];)_",iter, [&](){return rel_result_conflict_free_05673b16b868496c->size();});
signalHandler->setMsg(R"_(result_conflict_free(x,y) :- 
   output0(_,_,_,_,x,y).
in file 2_proposition_3.9_toegepast.dl [87:1-87:57])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_conflict_free;2_proposition_3.9_toegepast.dl [87:1-87:57];result_conflict_free(x,y) :- \n   output0(_,_,_,_,x,y).;)_",iter, [&](){return rel_result_conflict_free_05673b16b868496c->size();});
...
{
	Logger logger(R"_(@t-relation-savetime;result_conflict_free;2_proposition_3.9_toegepast.dl [85:7-85:27];savetime;)_",iter, [&](){return rel_result_conflict_free_05673b16b868496c->size();});
if (performIO) {
...
namespace  souffle {
using namespace souffle;
class Sf___proposition_3: public SouffleProgram {
public:
 Sf___proposition_3(std::string pf = "profile.log");
 ~Sf___proposition_3();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___proposition_3::Sf___proposition_3(std::string pf):
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___proposition_3::~Sf___proposition_3(){
}

void Sf___proposition_3::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf___proposition_3::run(){
runFunction("", "", false, false);
}

void Sf___proposition_3::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___proposition_3::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_conflict_free"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___proposition_3::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___proposition_3::dumpInputs(){
...
void Sf___proposition_3::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___proposition_3::getSymbolTable(){
return symTable;
}

RecordTable& Sf___proposition_3::getRecordTable(){
return recordTable;
}

void Sf___proposition_3::setNumThreads(std::size_t numThreadsValue){
...
void Sf___proposition_3::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "T1") {
stratum_T1_5c3ab2c64a54be91.run(args, ret);
return;}
if (name == "T2") {
...
void Sf___proposition_3::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___proposition_3(){return new  souffle::Sf___proposition_3;}
SymbolTable *getST___proposition_3(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___proposition_3*>(p)->getSymbolTable();}
} // namespace souffle
...
{
try{
souffle::CmdOptions opt(R"(2_proposition_3.9_toegepast.dl)",
R"()",
R"()",
true,
R"(/dev/null)",
...
souffle::Sf___proposition_3 obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___proposition_3: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___proposition_3();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___proposition_3::newInstance(){
return new  souffle::Sf___proposition_3();
}

 factory_Sf___proposition_3::factory_Sf___proposition_3():
souffle::ProgramFactory("__proposition_3"){
}
...
extern "C" {
souffle::factory_Sf___proposition_3 __factory_Sf___proposition_3_instance;
}
#endif
} // namespace souffle
