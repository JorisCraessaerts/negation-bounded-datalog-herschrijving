...
namespace  souffle {
using namespace souffle;
class Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std: public SouffleProgram {
public:
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std(std::string pf = "profile.log");
 ~Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std(std::string pf):
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::~Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std(){
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::run(){
runFunction("", "", false, false);
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_positive_rewritten"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::dumpInputs(){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::getSymbolTable(){
return symTable;
}

RecordTable& Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::getRecordTable(){
return recordTable;
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::setNumThreads(std::size_t numThreadsValue){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std(){return new  souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std;}
SymbolTable *getST___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std*>(p)->getSymbolTable();}
} // namespace souffle
...
souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::newInstance(){
return new  souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std();
}

 factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std::factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std():
souffle::ProgramFactory("__overbodige_regels_en_conflicten_in_inequalities_weggehaald__std"){
}
...
extern "C" {
souffle::factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std __factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__std_instance;
}
#endif
} // namespace souffle
