...
namespace  souffle {
using namespace souffle;
class Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt: public SouffleProgram {
public:
 Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt(std::string pf = "profile.log");
 ~Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt(std::string pf):
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::~Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt(){
}

void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::run(){
runFunction("", "", false, false);
}

void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_bounded_negation"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::dumpInputs(){
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::getSymbolTable(){
return symTable;
}

RecordTable& Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::getRecordTable(){
return recordTable;
}

void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::setNumThreads(std::size_t numThreadsValue){
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "T1") {
stratum_T1_5c3ab2c64a54be91.run(args, ret);
return;}
if (name == "T2") {
...
void Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___origineel_programma_bounded_negation_voor_herschrijving__noopt(){return new  souffle::Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt;}
SymbolTable *getST___origineel_programma_bounded_negation_voor_herschrijving__noopt(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt*>(p)->getSymbolTable();}
} // namespace souffle
...
souffle::Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::newInstance(){
return new  souffle::Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt();
}

 factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt::factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt():
souffle::ProgramFactory("__origineel_programma_bounded_negation_voor_herschrijving__noopt"){
}
...
extern "C" {
souffle::factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt __factory_Sf___origineel_programma_bounded_negation_voor_herschrijving__noopt_instance;
}
#endif
} // namespace souffle
