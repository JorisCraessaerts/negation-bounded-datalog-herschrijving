...
{
	Logger logger(R"_(@t-relation-loadtime;edge;5_adoms_weggehaald.dl [1:7-1:11];loadtime;)_",iter, [&](){return rel_edge_04d25f5060e9043b->size();});
if (performIO) {
...
ProfileEventSingleton::instance().makeQuantityEvent( R"(@n-nonrecursive-relation;edge;5_adoms_weggehaald.dl [1:7-1:11];)",rel_edge_04d25f5060e9043b->size(),iter);}
...
{
	Logger logger(R"_(@t-nonrecursive-relation;result_positive_rewritten;5_adoms_weggehaald.dl [4:7-4:32];)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   edge(x,y),
   edge(y,z),
   edge(z,x).
in file 5_adoms_weggehaald.dl [10:1-13:16])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [10:1-13:16];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z),\n   edge(z,x).;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 5_adoms_weggehaald.dl [17:1-17:100])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [17:1-17:100];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   y != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 5_adoms_weggehaald.dl [18:1-18:100])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [18:1-18:100];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   y != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 5_adoms_weggehaald.dl [20:1-20:107])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [20:1-20:107];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   y != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 5_adoms_weggehaald.dl [23:1-23:93])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [23:1-23:93];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 5_adoms_weggehaald.dl [24:1-24:93])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [24:1-24:93];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 5_adoms_weggehaald.dl [26:1-26:100])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [26:1-26:100];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   x != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 5_adoms_weggehaald.dl [29:1-29:99])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [29:1-29:99];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   y != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 5_adoms_weggehaald.dl [30:1-30:99])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [30:1-30:99];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   y != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 5_adoms_weggehaald.dl [32:1-32:106])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [32:1-32:106];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   y != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 5_adoms_weggehaald.dl [35:1-35:99])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [35:1-35:99];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   z1 != x,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 5_adoms_weggehaald.dl [36:1-36:99])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [36:1-36:99];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   z1 != x,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 5_adoms_weggehaald.dl [38:1-38:106])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;5_adoms_weggehaald.dl [38:1-38:106];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   y != x,\n   z1 != x,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
{
	Logger logger(R"_(@t-relation-savetime;result_positive_rewritten;5_adoms_weggehaald.dl [4:7-4:32];savetime;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if (performIO) {
...
namespace  souffle {
using namespace souffle;
class Sf___adoms_weggehaald__noopt: public SouffleProgram {
public:
 Sf___adoms_weggehaald__noopt(std::string pf = "profile.log");
 ~Sf___adoms_weggehaald__noopt();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___adoms_weggehaald__noopt::Sf___adoms_weggehaald__noopt(std::string pf):
...
wrapper_rel_result_positive_rewritten_f19b5b85867f266b(1, *rel_result_positive_rewritten_f19b5b85867f266b, *this, "result_positive_rewritten", std::array<const char *,2>{{"i:number","i:number"}}, std::array<const char *,2>{{"x","y"}}, 0),
...
stratum_result_positive_rewritten_16ede51278f68d5b(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_edge_04d25f5060e9043b,*rel_result_positive_rewritten_f19b5b85867f266b){
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___adoms_weggehaald__noopt::~Sf___adoms_weggehaald__noopt(){
}

void Sf___adoms_weggehaald__noopt::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
ProfileEventSingleton::instance().makeConfigRecord("relationCount", std::to_string(2));{
...
void Sf___adoms_weggehaald__noopt::run(){
runFunction("", "", false, false);
}

void Sf___adoms_weggehaald__noopt::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___adoms_weggehaald__noopt::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_positive_rewritten"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___adoms_weggehaald__noopt::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___adoms_weggehaald__noopt::dumpInputs(){
...
void Sf___adoms_weggehaald__noopt::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___adoms_weggehaald__noopt::getSymbolTable(){
return symTable;
}

RecordTable& Sf___adoms_weggehaald__noopt::getRecordTable(){
return recordTable;
}

void Sf___adoms_weggehaald__noopt::setNumThreads(std::size_t numThreadsValue){
...
void Sf___adoms_weggehaald__noopt::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "edge") {
stratum_edge_31e40d0d94fe9f7c.run(args, ret);
return;}
...
void Sf___adoms_weggehaald__noopt::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___adoms_weggehaald__noopt(){return new  souffle::Sf___adoms_weggehaald__noopt;}
SymbolTable *getST___adoms_weggehaald__noopt(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___adoms_weggehaald__noopt*>(p)->getSymbolTable();}
} // namespace souffle
...
{
try{
souffle::CmdOptions opt(R"(5_adoms_weggehaald.dl)",
R"()",
R"()",
true,
R"(/dev/null)",
...
souffle::Sf___adoms_weggehaald__noopt obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___adoms_weggehaald__noopt: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___adoms_weggehaald__noopt();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___adoms_weggehaald__noopt::newInstance(){
return new  souffle::Sf___adoms_weggehaald__noopt();
}

 factory_Sf___adoms_weggehaald__noopt::factory_Sf___adoms_weggehaald__noopt():
souffle::ProgramFactory("__adoms_weggehaald__noopt"){
}
...
extern "C" {
souffle::factory_Sf___adoms_weggehaald__noopt __factory_Sf___adoms_weggehaald__noopt_instance;
}
#endif
} // namespace souffle
