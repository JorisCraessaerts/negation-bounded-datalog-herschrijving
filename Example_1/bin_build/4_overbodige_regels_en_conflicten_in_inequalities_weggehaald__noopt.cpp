...
signalHandler->setMsg(R"_(+disconnected0() :- 
   edge(_,_).
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [6:1-6:23])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;+disconnected0;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [6:1-6:23];+disconnected0() :- \n   edge(_,_).;)_",iter, [&](){return rel_disconnected0_b2add3842fe11dfe->size();});
...
{
	Logger logger(R"_(@t-relation-loadtime;edge;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [1:7-1:11];loadtime;)_",iter, [&](){return rel_edge_04d25f5060e9043b->size();});
if (performIO) {
...
ProfileEventSingleton::instance().makeQuantityEvent( R"(@n-nonrecursive-relation;edge;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [1:7-1:11];)",rel_edge_04d25f5060e9043b->size(),iter);}
...
{
	Logger logger(R"_(@t-nonrecursive-relation;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [10:7-10:32];)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   edge(x,y),
   edge(y,z),
   edge(z,x).
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [16:1-19:16])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [16:1-19:16];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z),\n   edge(z,x).;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [23:1-23:140])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [23:1-23:140];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   y != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [24:1-24:140])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [24:1-24:140];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   y != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [26:1-26:147])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [26:1-26:147];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   y != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [29:1-29:133])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [29:1-29:133];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
auto range = rel_edge_04d25f5060e9043b->lowerUpperRange_10(Tuple<RamDomain,2>{{ramBitCast(env0[1]), ramBitCast<RamDomain>(MIN_RAM_SIGNED)}},Tuple<RamDomain,2>{{ramBitCast(env0[1]), ramBitCast<RamDomain>(MAX_RAM_SIGNED)}},READ_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt));
for(const auto& env1 : range) {
if( (ramBitCast<RamDomain>(env0[0]) != ramBitCast<RamDomain>(env1[1]))) {
auto range = rel_edge_04d25f5060e9043b->lowerUpperRange_01(Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MIN_RAM_SIGNED), ramBitCast(env0[0])}},Tuple<RamDomain,2>{{ramBitCast<RamDomain>(MAX_RAM_SIGNED), ramBitCast(env0[0])}},READ_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt));
for(const auto& env2 : range) {
if( (ramBitCast<RamDomain>(env0[1]) != ramBitCast<RamDomain>(env2[0]))) {
Tuple<RamDomain,2> tuple{{ramBitCast(env0[0]),ramBitCast(env0[1])}};
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [30:1-30:133])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [30:1-30:133];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [32:1-32:140])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [32:1-32:140];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   x != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [35:1-35:139])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [35:1-35:139];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   y != z1,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [36:1-36:139])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [36:1-36:139];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   y != z1,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [38:1-38:146])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [38:1-38:146];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   y != z1,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   y != z2.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [41:1-41:139])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [41:1-41:139];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   z1 != x,\n   x != y,\n   y != z2.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   x != y,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [42:1-42:139])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [42:1-42:139];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   z1 != x,\n   x != y,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
signalHandler->setMsg(R"_(result_positive_rewritten(x,y) :- 
   ...
   y != z2,
   z2 != x.
in file 4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [44:1-44:146])_");
{
	Logger logger(R"_(@t-nonrecursive-rule;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [44:1-44:146];result_positive_rewritten(x,y) :- \n   edge(x,y),\n   edge(y,z1),\n   edge(z2,x),\n   +disconnected0(),\n   y != x,\n   z1 != x,\n   x != y,\n   y != z2,\n   z2 != x.;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if(!(rel_disconnected0_b2add3842fe11dfe->empty()) && !(rel_edge_04d25f5060e9043b->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,rel_edge_04d25f5060e9043b->createContext());
CREATE_OP_CONTEXT(rel_result_positive_rewritten_f19b5b85867f266b_op_ctxt,rel_result_positive_rewritten_f19b5b85867f266b->createContext());
...
{
	Logger logger(R"_(@t-relation-savetime;result_positive_rewritten;4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl [10:7-10:32];savetime;)_",iter, [&](){return rel_result_positive_rewritten_f19b5b85867f266b->size();});
if (performIO) {
...
namespace  souffle {
using namespace souffle;
class Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt: public SouffleProgram {
public:
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt(std::string pf = "profile.log");
 ~Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt(std::string pf):
...
ProfileEventSingleton::instance().setOutputFile(profiling_fname);
 ...
 Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::~Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt(){
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::run(){
runFunction("", "", false, false);
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"name","result_positive_rewritten"},{"operation","output"},{"output-dir","."},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"auxArity","0"},{"fact-dir","."},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::dumpInputs(){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::getSymbolTable(){
return symTable;
}

RecordTable& Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::getRecordTable(){
return recordTable;
}

void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::setNumThreads(std::size_t numThreadsValue){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
...
void Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::dumpFreqs(){
}

} // namespace  souffle
namespace souffle {
SouffleProgram *newInstance___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt(){return new  souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt;}
SymbolTable *getST___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt(SouffleProgram *p){return &reinterpret_cast<souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt*>(p)->getSymbolTable();}
} // namespace souffle
...
{
try{
souffle::CmdOptions opt(R"(4_overbodige_regels_en_conflicten_in_inequalities_weggehaald.dl)",
R"()",
R"()",
true,
R"(/dev/null)",
...
souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt obj(opt.getProfileName());
#if defined(_OPENMP) 
...
namespace  souffle {
using namespace souffle;
class factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::newInstance(){
return new  souffle::Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt();
}

 factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt::factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt():
souffle::ProgramFactory("__overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt"){
}
...
extern "C" {
souffle::factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt __factory_Sf___overbodige_regels_en_conflicten_in_inequalities_weggehaald__noopt_instance;
}
#endif
} // namespace souffle
